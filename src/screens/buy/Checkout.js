                  ...
                  <SafeAreaView style={styles.scrollContainer}>
                    ...
                    >
                      ...
                      <View style={{width: width * 0.7, marginTop: 12}}>
                        ...
                        <Text style={styles.value}>Via Santa Margherita, 10</Text>
                      </View>
                      <View style={{width: width * 0.7, marginTop: 12}}>
                      ...
                      <View style={{width: width * 0.7, marginTop: 12}}>
                        <Text style={styles.label}>Giorni prenotazione</Text>
                      ...
                      <View style={{marginTop: 0, width: width, flexDirection: 'row', justifyContent: 'center'}}>
                        <UiButton
                          title="Paga e prenota"
                          fullWidth="0.8"
                          onPress={() => {this.goTo('buyCompleted')}}
                        />
                      </View>
                    </ScrollView>
                  </SafeAreaView>
